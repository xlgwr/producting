...
** 描述：
**    主要用于line别设置信息的资料新增、修改操作
*********************************************************************************/
namespace MachineSystem.TabPage
{
    public partial class frmEditP_Produce_Line : Framework.Abstract.frmBaseToolEntryXC
    {

        #region 变量定义
        public DataRow dr;
        // 日志
        private static readonly ILog log = LogManager.GetLogger(typeof(frmEditP_Produce_Line));

        #endregion

        #region 画面初始化
        public frmEditP_Produce_Line()
        {
            InitializeComponent();
